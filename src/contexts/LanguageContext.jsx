...
const translations = {
  ar: {
    ...
    official_retailer: "بائع رسمي",
    bonus_included: "بونص مشمول",
    competitive_ready: "جاهز للمنافسة",
    xbox_compatible: "متوافق مع إكس بوكس",
    battle_pass_ready: "جاهز للباتل باص",
    wishes_ready: "جاهز للتمنيات",
    global_use: "استخدام عالمي",
  ...
  en: {
    ...
    bonus_included: "Bonus Included",
    competitive_ready: "Competitive Ready",
    xbox_compatible: "Xbox Compatible",
    battle_pass_ready: "Battle Pass Ready",
    wishes_ready: "Wishes Ready",
    global_use: "Global Use",
